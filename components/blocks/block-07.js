(function (blocks, editor, element, components, data) {
    ...
    const blockStructure = (posts) => (
        el('div', { className: "block-07", style: { gridTemplateColumns: "repeat(auto-fit, minmax(104px, 1fr))" } },
            posts.map(post => (
    ...
    const icon = el('img', {src:'../wp-content/themes/litci/components/blocks/icons/block07.svg'})

    blocks.registerBlockType('litci/block-07', {
        title: 'LIT-Bloco 7',
        icon: icon,
