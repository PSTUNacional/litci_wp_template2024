(function (blocks, editor, element, components, data) {
    ...
    const blockStructure = (posts) => (el('div', { className: "block-08" },
        el('div', { className: "column main" },
        ...
        el('div', { className: "column minor" },
            posts.slice(5, 12).map(post => (
                el('article', { className: "unit-06", style: { paddingBottom: "0px" } },
                    el('div', { className: "column" },
